...
if has("gui_macvim")
  ...
  macm Edit.Find.Find\.\.\.			key=<c-f>
  macm Edit.Find.Find\ Next			key=<c-g> action=findNext:
  macm Edit.Find.Find\ Previous			key=<c-G> action=findPrevious:
  ...
  macm Tools.Make<Tab>:make			key=<C-b>
